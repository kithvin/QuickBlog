      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-12">
          ...
          <div className="bg-primary/5 p-6 rounded-xl shadow mt-6">
            ...
            <p className="text-gray-600">
              "The customization options in QuickBlog let me make my blog truly
              mine."
            </p>
          </div>
          ...
          <div className="bg-primary/5 p-6 rounded-xl shadow mt-10">
            ...
            <p className="text-gray-600">
              "Whenever I had questions, QuickBlog’s support team was quick and
              helpful."
            </p>
          </div>
          ...
          <div className="bg-primary/5 p-6 rounded-xl shadow mt-10">
            ...
            <p className="text-gray-600">
              "Super easy to use, and the reading experience is pleasant for my
              audience."
            </p>
          </div>
          ...
          <div className="bg-primary/5 p-6 rounded-xl shadow mt-10">
            ...
            <p className="text-gray-600">
              "QuickBlog helped me grow my readership steadily with great tools
              and insights."
            </p>
          </div>
          ...
          <div className="bg-primary/5 p-6 rounded-xl shadow mt-10">
            ...
            <p className="text-gray-600">
              "I can truly express myself with QuickBlog’s customizable layouts
              and themes."
            </p>
          </div>

      ...
      <div className="grid md:grid-cols-2 gap-12 mb-20">
        <div className="space-y-6">
          ...
          <p className="text-gray-700 text-justify leading-relaxed">
            ...
            their ideas, share stories, and connect with others. Whether you're
            a passionate writer or an enthusiastic reader, our platform brings
            the blog community together in one place. Anyone can write. Everyone
            can read. We believe in the power of personal stories. Here,
            creativity knows no bounds. Our platform encourages diverse voices
            from all walks of life to share their unique perspectives, insights,
            and experiences. Whether you want to inspire, educate, entertain, or
            simply share your journey, this is the perfect space to do so. We
            foster a welcoming and inclusive environment where ideas flourish
            and meaningful conversations begin. With easy-to-use tools and a
            supportive community, writing and publishing your thoughts has never
          ...
          <p className="text-gray-700 text-justify leading-relaxed">
            ...
            Our platform is not just about blogging.it’s about building genuine
            connections, sparking inspiration, and celebrating the timeless art
            of storytelling in all its diverse forms. Join us today and become
            part of a vibrant, supportive community where your voice truly
            matters, your stories are deeply valued, and your creativity is
            wholeheartedly celebrated. Together, we’re creating a welcoming
            space where everyone has the freedom to express themselves openly
            and the opportunity to be heard, understood, and inspired by others.
            Whether you’re here to share your journey or to learn from others,
            this is a place where meaningful conversations flourish and lifelong
      ...
      <div className="mb-20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-primary/5 p-10 rounded-xl shadow-sm text-center">
            ...
            <p className="text-gray-600">
              Engage with fellow writers, share your thoughts through comments,
              and follow inspiring authors you love.
            </p>
          </div>
          <div className="bg-primary/5 p-10 rounded-xl shadow-sm text-center">
            <h3 className="text-xl font-bold text-blue-600 mb-8">
            ...
            <p className="text-gray-600">
            Share your unique experiences and actively build your personal blogging profile with ease.
            </p>
          </div>
        </div>
      </div>
